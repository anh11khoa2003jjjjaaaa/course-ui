...
//       // const video = `https://backendcourse.onrender.com/video/${response.data.videoUrl.split('\\').pop()}`;
//       // setVideoUrl(video);
//     } catch (error) {
...
//     const video=await axios.delete(`https://backendcourse.onrender.com/public/courses/${courseId}`);
...
//     try {
//       await axios.put(`https://backendcourse.onrender.com/public/courses/${courseId}/status`, { status: 2 });
//       fetchApprovedCourses();
...
//       await axios.put(`https://backendcourse.onrender.com/public/courses/cancelReason/${selectedCourse.id}`, null, {
...
const TeacherCoursePage = () => {
  ...
  //   const video = `https://backendcourse.onrender.com/video/${videoUrl.split('\\').pop()}`;
  //   setVideoUrl(video);
